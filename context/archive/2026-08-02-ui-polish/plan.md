...
- [x] 6.1 Lint passes: `npm run lint` — b85947d
- [x] 6.2 Build passes: `npm run build` — b85947d

#### Manual

- [x] 6.3 `confirm-email.astro` shows icons, not emoji — b85947d
- [x] 6.4 Deck-list Delete action visually matches the rest of the app's buttons — b85947d
- [x] 6.5 Full click-through of all 12 screens shows no remaining archetype stragglers and no regressions introduced by Phases 1-5 — b85947d
